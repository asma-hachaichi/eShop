          ...
          <br/><br/>
            ...
            <?php
                if ($res_data ->num_rows==0){?>
                  <div id="panier"><center><h3>Aucun Produit !</h3></center></div>
            ...
            ?>
              <tr>
                ...
                <td><img src="./img_prod/<?php echo $row['img'];?>" height=40px width=40px  onError="this.onerror=null;this.src='/favicon.png';" ></td>
                <td><?php echo $row['libelle'];?></td>
                <td><?php echo $row['description'];?></td>
                <td><?php echo $row['prix'];?></td>
                <td style="padding-left: 34px;"><a href="deleteP.php?idp=<?php echo $row['idp'];?>"><img src="trash.svg" height=23px width=23px></a></td>
              </tr>
              <?php } ?>
            </tbody>
          </table>
