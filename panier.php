          ...
          <br/><br/>
            ...
            <?php
                if ($res_data ->num_rows==0){?>
                  <div id="panier"><center><h3>Votre panier est vide !</h3></center></div>
            ...
            ?>
              <tr>
                ...
                <td><img src="./img_prod/<?php echo $row['img'];?>" height=40px width=40px></td>
                <td><?php echo $row['libelle'];?></td>
                <td><?php echo $row['qtte'];?></td>
                <td><?php echo $row['qtte']*$row['prix'];?></td>
                <td style="padding-left: 34px;"><a href="delete.php"><img src="trash.svg" height=23px width=23px></a></td>
              </tr>
            <?php
                $i++;
                $tot+=$row['qtte']*$row['prix'];
                }  
            ?>
            </tbody>
          </table>
          <br/>
          <center><h4>Prix total : <?php echo $tot;?></h4></center>
          <br/>
          <div class="d-grid gap-2 col-6 mx-auto">
            <a class="btn btn-primary" href="confirm-commande.php?tot=<?php echo $tot;?>" role="button">Valider commande</a>
          </div>
          <?php } ?>
